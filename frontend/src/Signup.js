								...
								<div class="relative px-4 py-10 bg-bone border-b-8 border-r-8 border-beige drop-shadow-lg sm:rounded-3xl sm:p-20">
									<div class="max-w-md mx-auto w-96">
										...
										<div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                            ...
                                            <div class="relative">
													<input autoComplete="off" id="companyName" name="companyName" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Company Name" value={ companyName } onChange={(e) => setCompanyName(e.target.value)} />
                                                ...
                                                <div class="relative">
													<input autoComplete="off" id="typeOfBusiness" name="typeOfBusiness" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Type of business" value={ typeOfBusiness } onChange={(e) => setTypeOfBusiness(e.target.value)} />
                                                ...
                                                <div class="relative">
													<input autoComplete="off" id="address" name="address" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Type of business" value={ address } onChange={(e) => setAddress(e.target.value)} />
                                                ...
                                                <div class="relative">
													<input autoComplete="off" id="phoneNumber" name="phoneNumber" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Type of business" value={ phoneNumber } onChange={(e) => setPhoneNumber(e.target.value)} />
												...
												<div class="relative">
													<input autoComplete="off" id="email" name="email" type="text" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Email address" value={ email } onChange={(e) => setEmail(e.target.value)} />
													<label for="email" class="absolute left-0 -top-3.5 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm">Email Address</label>
												</div>
												<div class="relative">
													<input autoComplete="off" id="password" name="password" type="password" class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600" placeholder="Password" value={ password } onChange={(e) => setPassword(e.target.value)} />
