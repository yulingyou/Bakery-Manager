...
{/* cards that contain 3 elements */}
            <div className="fixed mt-40 top-80 left-80 right-30 card-body bg-darkgreen card shadow-xl w-96">
                <label htmlFor="my-modal" className="btn text-bone ">Current orders</label>
            ...
            <label htmlFor="my-modal" className="btn text-bone">Previous orders</label>
            <input type="checkbox" id="my-modal" className="modal-toggle" />
                <div className="modal">
                    <div className="modal-box">
                ...
                <label htmlFor="my-modal" className="btn text-bone ">Invoices</label>
                <input type="checkbox" id="my-modal" className="modal-toggle" />
                <div className="modal">
                    <div className="modal-box">
